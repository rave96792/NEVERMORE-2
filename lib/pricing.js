...
export function computeTotals({ subtotal, shippingState, shippingCountry, deliveryMethod }) {
  ...
  return { subtotal: round2(subtotal), shipping: round2(shipping), tax, total, taxRate: rate, taxState: state || null, deliveryMethod: deliveryMethod === 'pickup' ? 'pickup' : 'ship' }
}
